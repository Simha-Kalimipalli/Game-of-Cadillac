...
class Game:
  ...
  nam_arr = ["H2","H3","H4","H5","H6","H7","H8","H9","H10","HJ","HQ","HK","HA", "C2","C3","C4","C5","C6","C7","C8","C9","C10","CJ","CQ","CK","CA",\
             "D2","D3","D4","D5","D6","D7","D8","D9","D10","DJ","DQ","DK","DA", "S2","S3","S4","S5","S6","S7","S8","S9","S10","SJ","SQ","SK","SA"]
  
  suit_list_arr = ["Hearts","Hearts","Hearts","Hearts","Hearts","Hearts","Hearts","Hearts","Hearts","Hearts","Hearts","Hearts","Hearts",\
                   ...
                   "Spades","Spades","Spades","Spades","Spades","Spades","Spades","Spades","Spades","Spades","Spades","Spade","Spades"]
  deck = []  
   ...
   # dcar = [23,24]
    ...
    if input1== 1:
      ...
      if ((input2 == "y") or (input2== 'Y')): 
        print("Which card you want to switch with: " + str(player[0].name) +" [1], " + str(player[1].name) +"  [2]," + str(player[2].name)+" [3]")
        input3 = int(input())
        b = input3 - 1
        ...
        print("Whic card you want to switch with: " + str(player[0].name) +" [1], " + str(player[1].name) +"  [2]," + str(player[2].name)+" [3]")
        input4 = int(input())
        ap = input4 - 1
        c = player[ap]
        d = Game.discard.pop()
